...
<g:set var="readonly" value=""/>
<sec:ifNotGranted roles="${Authority.ROLE_USER}">
    <g:set var="readonly" value="disabled"/>
    ...
    <div class="alert alert-warning" role="alert">
        ...
        <g:message code="default.readonly.message"/>
    </div>
</sec:ifNotGranted>
                        ...
                        <div class="form-group removable">
                            ...
                            <div class="col-xs-8">
                                <g:select id="collection.location[${i}].depot" name="collection.location[${i}].depot"
                                          class="form-control" from="${depots}" value="${location.depot?.id}"
                                          optionKey="id"
                            ...
                            <div class="col-xs-5">
                                <div class="checkbox">
                                    <label for="collection.analogMaterialCollection[${i}].materialType">
                                        <input type="hidden"
                                               name="collection.analogMaterialCollection[${i}].materialTypeId"
                        ...
                        <g:each in="${materialTypes}" var="materialType" status="i">
                                ...
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <g:select id="collection.digitalMaterialCollection.unit"
                                                  ...
                                                  value="${collection.digitalMaterialCollection?.unit?.id}"
                                                  optionKey="id"
                                                  optionValue="name"/>
                                    </div>
                                </div>
                            ...
                            <g:if test="${(i == 9) && (digitalMaterialStatus?.manifestCsvId)}">
                                <div class="col-xs-12 text-center">
                                    <g:link controller="download" action="manifest"
                                            id="${digitalMaterialStatus.manifestCsvId}"
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body form-control-listing">
                        ...
                        <g:each in="${miscMaterialTypes}" var="materialType" status="i">
                            ...
                            <g:set var="material"
                                   value="${collection.miscMaterialCollection?.getMaterialByType(materialType)}"/>

                            <div class="col-xs-6">
                                <div class="checkbox">
                                    <label for="collection.miscMaterialCollection[${i}].materialType">
                                        <input type="hidden"
                                               name="collection.miscMaterialCollection[${i}].materialTypeId"
                                               value="${materialType.id}"/>
                    ...
                    <div class="form-group form-group-nested">
                        <div class="col-xs-24">
                            ...
                            <g:select id="collection.level" name="collection.level"
                                      class="form-control" from="${priorities}" value="${collection.level?.id}"
                                      optionKey="id"
                                      optionValue="name" noSelection="${['null': '']}"/>
                        </div>
                    </div>
        ...
        <sec:ifAnyGranted roles="${Authority.ROLE_USER}">
            <div class="form-group hidden-print">
                <div class="col-xs-22 text-right">
                    ...
                    <g:link action="list" params="${request.getAttribute('queryParams')}"
