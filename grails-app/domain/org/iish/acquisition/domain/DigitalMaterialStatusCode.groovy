...
class DigitalMaterialStatusCode {
	...
	public static final long READY_FOR_PERMANENT_STORAGE = 4L
	public static final long UPLOADING_TO_PERMANENT_STORAGE = 5L
	public static final long MOVED_TO_PERMANENT_STORAGE = 6L
